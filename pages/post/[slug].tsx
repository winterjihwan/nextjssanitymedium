...
function Post({ post }: Props) {
  ...
  return (
    <main>
        ...
        <div className="mt-10">
          <PortableText
            ...
            serializers={{
              ...
              h2: (props: any) => <h1 className="text-xl font-bold my-5" {...props}></h1>,
              li: ({ children }: any) => {
      ...
      {submitted ? (
        <div className="flex flex-col pl-5 py-10 my-10 bg-yellow-500 text-white max-w-2xl mx-auto">
        ...
        >
          ...
          <input {...register("_id")} type="hidden" name="_id" value={post._id.toString()} />
          ...
          {/* {errors will return when field validating fails} */}
